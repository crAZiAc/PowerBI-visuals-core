!function(modules) {
    ...
    464: function(module, exports, __webpack_require__) {
        ...
        window.debug = window.debug || {}, window.InJs = window.InJs || {}, __webpack_require__(465);
    },
    465: function(module, exports, __webpack_require__) {
        window.jsCommon, window.powerbi, window.powerbitests, window.InJs, window.debug, 
        window.jasmine, window.Microsoft;
        __webpack_require__(466), __webpack_require__(467), __webpack_require__(468), __webpack_require__(469), 
        __webpack_require__(470), __webpack_require__(471), __webpack_require__(472), __webpack_require__(473), 
        __webpack_require__(474), __webpack_require__(475), __webpack_require__(476), __webpack_require__(477), 
            ...
            !function(extensibility) {
                ...
                !function(legacy) {
                    ...
                    function getSelectors(args) {
                        return null != args.selectors ? args.selectors : args.data;
                    }
                    ...
                    var overloadFactory = function(visual) {
                        return {
                            ...
                            enumerateObjectInstances: function(options) {
                                if (visual.enumerateObjectInstances) return visual.enumerateObjectInstances(options);
                            }
                        };

!function(modules) {
    ...
    301: function(module, exports, __webpack_require__) {
        ...
        window.debug = window.debug || {}, window.InJs = window.InJs || {}, __webpack_require__(302);
    },
    302: function(module, exports, __webpack_require__) {
        ...
        __webpack_require__(66), __webpack_require__(67), __webpack_require__(315), __webpack_require__(68), 
        __webpack_require__(69), __webpack_require__(316), __webpack_require__(317), __webpack_require__(318), 
        ...
        __webpack_require__(327), __webpack_require__(70), __webpack_require__(71), __webpack_require__(328), 
        __webpack_require__(329), __webpack_require__(72), __webpack_require__(330), __webpack_require__(322), 
    ...
    314: function(module, exports) {
        ...
        !function(jsCommon) {
            ...
            !function(CssConstants) {
                ...
                CssConstants.fontSizeProperty = "font-size", CssConstants.fontWeightProperty = "font-weight", 
                CssConstants.colorProperty = "color", CssConstants.opacityProperty = "opacity", 
                CssConstants.paddingLeftProperty = "padding-left", CssConstants.paddingRightProperty = "padding-right", 
                CssConstants.positionProperty = "position", CssConstants.maxWidthProperty = "max-width", 
                CssConstants.minWidthProperty = "min-width", CssConstants.overflowProperty = "overflow", 
                CssConstants.overflowXProperty = "overflow-x", CssConstants.overflowYProperty = "overflow-y", 
                CssConstants.transformProperty = "transform", CssConstants.webkitTransformProperty = "-webkit-transform", 
                CssConstants.cursorProperty = "cursor", CssConstants.visibilityProperty = "visibility", 
                CssConstants.absoluteValue = "absolute", CssConstants.zeroPixelValue = "0px", CssConstants.autoValue = "auto", 
                CssConstants.hiddenValue = "hidden", CssConstants.noneValue = "none", CssConstants.blockValue = "block", 
                CssConstants.inlineBlockValue = "inline-block", CssConstants.transparentValue = "transparent", 
                CssConstants.boldValue = "bold", CssConstants.visibleValue = "visible", CssConstants.tableRowValue = "table-row", 
        ...
        !function(jsCommon) {
            ...
            !function(Formatting) {
                ...
                function fixDateTimeFormat(format) {
                    ...
                    })), format.indexOf("%") !== -1 && format.length > 2) for (var i = 0; i < regexCache.length; i++) format = format.replace(regexCache[i].r, regexCache[i].s);
                    return format;
                }
                var regexCache;
    ...
    319: function(module, exports) {
        ...
        !function(jsCommon) {
            function requires(dependency, to) {
                ...
                if (dependency.javaScriptFiles) for (var i = 0, len = dependency.javaScriptFiles.length; i < len; ++i) scriptsToRun.push({
            ...
            function loadStyleSheets(hrefList) {
                hrefList.forEach(function(href) {
                    styleSheetLoaded.indexOf(href) === -1 && (styleSheetLoaded.push(href), loadStyleSheet(href));
                });
            }
            function loadJavaScriptFiles(scripts, callback) {
                ...
                scripts.forEach(function(script, index) {
                    ...
                    javaScriptFilesLoaded.indexOf(file) === -1 ? file in javaScriptFilesLoading ? javaScriptFilesLoading[file].push(function() {
                ...
                asyncLoop(sourceCodeList, parseJavaScript, function() {
                    scripts.forEach(function(script) {
                        ...
                        listeners && listeners.forEach(function(listener) {
                            listener();
                        }), delete javaScriptFilesLoading[file], javaScriptFilesLoaded.indexOf(file) === -1 && javaScriptFilesLoaded.push(file);
                    });
                });
            }
            ...
            function asyncLoop(enumerable, func, callback) {
                for (var steps = [], i = 0, len = enumerable.length; i < len - 1; i++) !function(i) {
        ...
        !function(powerbi) {
            ...
            !function(TextMeasurementService) {
                ...
                function getTailoredTextOrDefault(textProperties, maxWidth) {
                    ...
                    if (width < maxWidth) return textProperties.text;
                    for (var copiedTextProperties = powerbi.Prototype.inherit(textProperties), text = copiedTextProperties.text = ellipsis + copiedTextProperties.text, min = 1, max = text.length, i = ellipsis.length; min <= max; ) if (i = (min + max) / 2 | 0, 

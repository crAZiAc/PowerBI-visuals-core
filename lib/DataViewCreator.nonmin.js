!function(modules) {
    ...
    __webpack_require__(62)(__webpack_require__(63) + "\n\n// SCRIPT-LOADER FOOTER\n//# sourceURL=script:///D:/Source/projects/PowerBI/source/PowerBI-visuals-core/src/Clients/Externals/ThirdPartyIP/LoDash/lodash.min.js");
}, function(module, exports) {
    ...
    __webpack_require__(62)(__webpack_require__(65) + "\n\n// SCRIPT-LOADER FOOTER\n//# sourceURL=script:///D:/Source/projects/PowerBI/source/PowerBI-visuals-core/src/Clients/Externals/ThirdPartyIP/D3/d3.min.js");
}, function(module, exports) {
    ...
    !function(jsCommon) {
        ...
        !function(StringExtensions) {
            ...
            function repeat(char, count) {
                for (var result = "", i = 0; i < count; i++) result += char;
                return result;
            }
        ...
        var Utility = function() {
            ...
            return Utility.throwIfNullOrUndefined = function(value, context, methodName, parameterName) {
                ...
                var url = path;
                return url && url.indexOf("http") === -1 && (url = jsCommon.Utility.urlCombine(Utility.staticContentLocation, url)), 
                url;
        ...
        !function(PerformanceUtil) {
            ...
            var PerfMarker = function() {
                ...
                return PerfMarker.begin = function(name) {
                    if (void 0 !== window.performance && void 0 !== performance.mark) return console.time, 
                    name = "Begin " + name, performance.mark(name), name;
                ...
                var SQExprBuilder = powerbi.data.SQExprBuilder, DataViewBuilder = function() {
                    ...
                    return DataViewBuilder.setDefaultQueryName = function(source) {
                        ...
                        if (optionsIdentityExpressions.length > 1) for (var identityExpressionsLength = optionsIdentityExpressions.length, identityExpressionsValuesLength = _.max(_.map(optionsIdentityExpressions, function(x) {
                            return x.length;
                        })), vi = 0; vi < identityExpressionsValuesLength; vi++) {
                            for (var current = optionsIdentityExpressions[0][vi], ci = 1; ci < identityExpressionsLength; ci++) current = SQExprBuilder.and(current, optionsIdentityExpressions[ci][vi]);
                    ...
                    }, DataViewBuilder.createDataViewBuilderColumnOptions = function(categoriesColumns, valuesColumns, filter, customizeColumns) {
                        ...
                        }), customizeColumns && allColumns.forEach(function(column) {
                            return customizeColumns(column.source);
                        }), allColumns.forEach(function(column) {
                            if (column.source.format) {
                                var objects = column.source.objects = column.source.objects || {};
                                objects.general = objects.general || {}, objects.general.formatString = objects.general.formatString || column.source.format;
                            }
                        }), {
                        ...
                        return dataView;
                    }, DataViewBuilder.prototype.createCategoricalDataViewBuilder = function(categoriesColumns, valuesColumns, columnNames, customizeColumns) {
                        ...
                        }, customizeColumns), options = DataViewBuilder.setUpDataViewBuilderColumnOptions(originalOptions, this.aggregateFunction);
